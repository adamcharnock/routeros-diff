...
setup(
    ...
    license='MIT',
    entry_points={"console_scripts": ["routeros_diff = routeros_diff.commands.diff:run", "ros_diff = routeros_diff.commands.diff:run", "routeros_prettify = routeros_diff.commands.prettify:run", "ros_prettify = routeros_diff.commands.prettify:run"]},
